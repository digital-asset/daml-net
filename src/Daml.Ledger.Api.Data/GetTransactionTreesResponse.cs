...
namespace Com.Daml.Ledger.Api.Data 
{
    public class GetTransactionTreesResponse
    {
        ...
        public static GetTransactionTreesResponse FromProto(DigitalAsset.Ledger.Api.V1.GetTransactionTreesResponse response) => new GetTransactionTreesResponse(from t in response.Transactions select TransactionTree.FromProto(t));

        public DigitalAsset.Ledger.Api.V1.GetTransactionTreesResponse ToProto()
        {
            var response = new DigitalAsset.Ledger.Api.V1.GetTransactionTreesResponse();
