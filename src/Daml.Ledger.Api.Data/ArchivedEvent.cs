...
namespace Com.Daml.Ledger.Api.Data 
{
    public sealed class ArchivedEvent : IEvent
    {
        ...
        public DigitalAsset.Ledger.Api.V1.ArchivedEvent ToProto()
        {
            var archivedEvent = new DigitalAsset.Ledger.Api.V1.ArchivedEvent { ContractId = ContractId, EventId = EventId, TemplateId = TemplateId.ToProto() };
            archivedEvent.WitnessParties.AddRange(WitnessParties);
            return archivedEvent;
        }

        public static ArchivedEvent FromProto(DigitalAsset.Ledger.Api.V1.ArchivedEvent archivedEvent) => new ArchivedEvent(archivedEvent.WitnessParties, archivedEvent.EventId, Identifier.FromProto(archivedEvent.TemplateId), archivedEvent.ContractId);
    }
} 
