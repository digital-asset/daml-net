...
namespace Com.Daml.Ledger.Api.Data
{
    public class GetPackageStatusResponse
    {
        public class PackageStatus
        {
            ...
            {
                foreach (var s in Enum.GetValues(typeof(DigitalAsset.Ledger.Api.V1.PackageStatus)))
        ...
        public static GetPackageStatusResponse FromProto(DigitalAsset.Ledger.Api.V1.GetPackageStatusResponse p) => new GetPackageStatusResponse(PackageStatus.ValueOf((int) p.PackageStatus));
    }
} 
