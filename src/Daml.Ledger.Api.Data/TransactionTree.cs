...
namespace Com.Daml.Ledger.Api.Data 
{
    public class TransactionTree : IComparable<TransactionTree>, IEquatable<TransactionTree>
    {
        ...
        public static TransactionTree FromProto(DigitalAsset.Ledger.Api.V1.TransactionTree tree)
        {
        ...
        public DigitalAsset.Ledger.Api.V1.TransactionTree ToProto()
        {
            var transactionTree = new DigitalAsset.Ledger.Api.V1.TransactionTree { TransactionId = TransactionId, CommandId = CommandId, WorkflowId = WorkflowId,
