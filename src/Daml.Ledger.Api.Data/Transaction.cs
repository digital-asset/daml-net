...
namespace Com.Daml.Ledger.Api.Data
{
    public class Transaction : IWorkflowEvent, IComparable<Transaction>, IEquatable<Transaction>
    {
        ...
        public static Transaction FromProto(DigitalAsset.Ledger.Api.V1.Transaction transaction)
        {
        ...
        public DigitalAsset.Ledger.Api.V1.Transaction ToProto()
        {
            var transaction = new DigitalAsset.Ledger.Api.V1.Transaction { TransactionId = TransactionId, CommandId = CommandId, WorkflowId = WorkflowId,
