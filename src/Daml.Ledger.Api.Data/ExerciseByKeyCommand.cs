...
namespace Com.Daml.Ledger.Api.Data 
{
    public class ExerciseByKeyCommand : Command
    {
        ...
        public static ExerciseByKeyCommand FromProto(DigitalAsset.Ledger.Api.V1.ExerciseByKeyCommand command)
        {
        ...
        public DigitalAsset.Ledger.Api.V1.ExerciseByKeyCommand ToProto()
        {
            return new DigitalAsset.Ledger.Api.V1.ExerciseByKeyCommand { TemplateId = TemplateId.ToProto(), ContractKey = ContractKey.ToProto(), Choice = Choice, ChoiceArgument = ChoiceArgument.ToProto() };
        }
