...
namespace Com.Daml.Ledger.Api.Data 
{
    public class GetTransactionsResponse
    {
        ...
        public static GetTransactionsResponse FromProto(DigitalAsset.Ledger.Api.V1.GetTransactionsResponse response) => new GetTransactionsResponse(from t in response.Transactions select Transaction.FromProto(t));

        public DigitalAsset.Ledger.Api.V1.GetTransactionsResponse ToProto()
        {
            var response = new DigitalAsset.Ledger.Api.V1.GetTransactionsResponse();
