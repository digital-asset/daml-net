 ...
 * Changed namespace and removed the IConvertable interface
 */
...
namespace Com.Daml.Ledger.Api.Util
{
    ...
    /// </remarks>
    [Serializable]
    public class BigInteger : IComparable, IEquatable<BigInteger>
    {
        #region Data
        ...
        private static void DivMod(uint[] x, uint[] y, out uint[] q, out uint[] r)
        {
            ...
            int shift = (int) Util.LeadingZeroCount(y[0]);
