...
namespace Com.Daml.Ledger.Api.Data 
{
    public abstract class LedgerOffset
    {
        ...
        public static LedgerOffset FromProto(DigitalAsset.Ledger.Api.V1.LedgerOffset ledgerOffset)
        {
            switch (ledgerOffset.ValueCase)
            {
                case DigitalAsset.Ledger.Api.V1.LedgerOffset.ValueOneofCase.Absolute:
                    return new Absolute(ledgerOffset.Absolute);
                case DigitalAsset.Ledger.Api.V1.LedgerOffset.ValueOneofCase.Boundary:
                    switch (ledgerOffset.Boundary)
                    {
                        case DigitalAsset.Ledger.Api.V1.LedgerOffset.Types.LedgerBoundary.LedgerBegin:
                            return LedgerBegin.Instance;
                        case DigitalAsset.Ledger.Api.V1.LedgerOffset.Types.LedgerBoundary.LedgerEnd:
                            return LedgerEnd.Instance;
                        default:
                            throw new LedgerBoundaryUnrecognized(ledgerOffset.Boundary);
                    }
                case DigitalAsset.Ledger.Api.V1.LedgerOffset.ValueOneofCase.None:
                default:
                    throw new LedgerBoundaryUnset(ledgerOffset);
            }
        }

        public DigitalAsset.Ledger.Api.V1.LedgerOffset ToProto()
        {
            if (this is LedgerBegin)
                return new DigitalAsset.Ledger.Api.V1.LedgerOffset { Boundary = DigitalAsset.Ledger.Api.V1.LedgerOffset.Types.LedgerBoundary.LedgerBegin };

            if (this is LedgerEnd) 
                return new DigitalAsset.Ledger.Api.V1.LedgerOffset { Boundary = DigitalAsset.Ledger.Api.V1.LedgerOffset.Types.LedgerBoundary.LedgerEnd };
            ...
            if (this is Absolute)
            {
                ...
                return new DigitalAsset.Ledger.Api.V1.LedgerOffset { Absolute = ((Absolute)this).Offset };
            }
    ...
    {
        public LedgerBoundaryUnrecognized(DigitalAsset.Ledger.Api.V1.LedgerOffset.Types.LedgerBoundary boundary)
    ...
    {
        public LedgerBoundaryUnset(DigitalAsset.Ledger.Api.V1.LedgerOffset offset)
