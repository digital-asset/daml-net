...
namespace Com.Daml.Ledger.Api.Data 
{
    public class CreateAndExerciseCommand : Command
    {
        ...
        public static CreateAndExerciseCommand FromProto(DigitalAsset.Ledger.Api.V1.CreateAndExerciseCommand command)
        {
        ...
        public DigitalAsset.Ledger.Api.V1.CreateAndExerciseCommand ToProto()
        {
            return new DigitalAsset.Ledger.Api.V1.CreateAndExerciseCommand { TemplateId = TemplateId.ToProto(), CreateArguments = CreateArguments.ToProtoRecord(),
