...
using Optional = Com.Daml.Ledger.Api.Util.Optional;
...
namespace Com.Daml.Ledger.Api.Data 
{
    public class CompletionStreamResponse
    {
        ...
        public CompletionStreamResponse(Optional<Checkpoint> checkpoint, IEnumerable<DigitalAsset.Ledger.Api.V1.Completion> completions)
        {
        ...
        public static CompletionStreamResponse FromProto(DigitalAsset.Ledger.Api.V1.CompletionStreamResponse response)
        {
        ...
        public DigitalAsset.Ledger.Api.V1.CompletionStreamResponse ToProto()
        {
            var response = new DigitalAsset.Ledger.Api.V1.CompletionStreamResponse();
