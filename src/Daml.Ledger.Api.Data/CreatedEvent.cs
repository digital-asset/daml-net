...
namespace Com.Daml.Ledger.Api.Data 
{
    public sealed class CreatedEvent : TreeEvent, IEvent
    {
        ...
        public DigitalAsset.Ledger.Api.V1.CreatedEvent ToProto()
        {
            var createdEvent = new DigitalAsset.Ledger.Api.V1.CreatedEvent
            {
                ContractId = ContractId,
        ...
        public static CreatedEvent FromProto(DigitalAsset.Ledger.Api.V1.CreatedEvent createdEvent)
        {
