...
namespace Com.Daml.Ledger.Api.Data 
{
    public class Checkpoint
    {
        ...
        public static Checkpoint FromProto(DigitalAsset.Ledger.Api.V1.Checkpoint checkpoint) => new Checkpoint(checkpoint.RecordTime.ToDateTimeOffset(), LedgerOffset.FromProto(checkpoint.Offset));

        public DigitalAsset.Ledger.Api.V1.Checkpoint ToProto() => new DigitalAsset.Ledger.Api.V1.Checkpoint { RecordTime = Google.Protobuf.WellKnownTypes.Timestamp.FromDateTimeOffset(RecordTime), Offset = Offset.ToProto() };
