...
namespace Com.Daml.Ledger.Api.Data 
{
    public sealed class Record : Value
    {
        ...
        public static Record FromProto(DigitalAsset.Ledger.Api.V1.Record record)
        {
        ...
        public override DigitalAsset.Ledger.Api.V1.Value ToProto() => new DigitalAsset.Ledger.Api.V1.Value { Record = ToProtoRecord() };

        public DigitalAsset.Ledger.Api.V1.Record ToProtoRecord()
        {
            DigitalAsset.Ledger.Api.V1.Record record = new DigitalAsset.Ledger.Api.V1.Record();
