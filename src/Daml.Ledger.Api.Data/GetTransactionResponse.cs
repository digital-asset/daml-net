...
namespace Daml.Ledger.Api.Data 
{
    ...
    public class GetTransactionResponse
    {
        ...
        public static GetTransactionResponse FromProto(Com.DigitalAsset.Ledger.Api.V1.GetTransactionResponse response) => new GetTransactionResponse(TransactionTree.FromProto(response.Transaction));

        public Com.DigitalAsset.Ledger.Api.V1.GetTransactionResponse ToProto() => new Com.DigitalAsset.Ledger.Api.V1.GetTransactionResponse { Transaction = Transaction.ToProto() };
