...
namespace Com.Daml.Ledger.Api.Data 
{
    public class ExerciseCommand : Command
    {
        ...
        public static ExerciseCommand FromProto(DigitalAsset.Ledger.Api.V1.ExerciseCommand command)
        {
        ...
        public DigitalAsset.Ledger.Api.V1.ExerciseCommand ToProto()
        {
            return new DigitalAsset.Ledger.Api.V1.ExerciseCommand { TemplateId = TemplateId.ToProto(), ContractId = ContractId, Choice = Choice, ChoiceArgument = ChoiceArgument.ToProto() };
        }
