...
namespace Com.Daml.Ledger.Api.Data
{
    public class GetActiveContractsResponse : IWorkflowEvent
    {
        ...
        public static GetActiveContractsResponse FromProto(DigitalAsset.Ledger.Api.V1.GetActiveContractsResponse response)
        {
        ...
        public DigitalAsset.Ledger.Api.V1.GetActiveContractsResponse ToProto()
        {
            var response = new DigitalAsset.Ledger.Api.V1.GetActiveContractsResponse { WorkflowId = WorkflowId };
