...
namespace Daml.Ledger.Api.Data 
{
    ...
    public class GetActiveContractsRequest
    {
        ...
        public static GetActiveContractsRequest FromProto(Com.DigitalAsset.Ledger.Api.V1.GetActiveContractsRequest request) => new GetActiveContractsRequest(request.LedgerId, TransactionFilter.FromProto(request.Filter), request.Verbose);

        public Com.DigitalAsset.Ledger.Api.V1.GetActiveContractsRequest ToProto() => new Com.DigitalAsset.Ledger.Api.V1.GetActiveContractsRequest { LedgerId = LedgerId, Filter = TransactionFilter.ToProto(), Verbose = Verbose };
