...
namespace Daml.Ledger.Api.Data 
{
    ...
    public class CompletionStreamRequest
    {
        ...
        public static CompletionStreamRequest FromProto(Com.DigitalAsset.Ledger.Api.V1.CompletionStreamRequest request)
        {
        ...
        public Com.DigitalAsset.Ledger.Api.V1.CompletionStreamRequest ToProto()
        {
            var request = new Com.DigitalAsset.Ledger.Api.V1.CompletionStreamRequest { LedgerId = LedgerId, ApplicationId = ApplicationId };
