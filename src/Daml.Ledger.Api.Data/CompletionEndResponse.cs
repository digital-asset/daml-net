...
namespace Com.Daml.Ledger.Api.Data 
{
    public sealed class CompletionEndResponse
    {
        ...
        public static CompletionEndResponse FromProto(DigitalAsset.Ledger.Api.V1.CompletionEndResponse response) => new CompletionEndResponse(LedgerOffset.FromProto(response.Offset));
