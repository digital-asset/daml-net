 ...
 *
 * Also added tests for ToPlainString()
 */
...
namespace Daml.Ledger.Api.Data.Util.Test
{
    ...
    public class BigDecimalTest
    {
        ...
        public void CanConvertToPlainString()
        {
            ...
            TestPlainString("1",         "1");
            TestPlainString("10",        "10");
            TestPlainString("2e1",       "20");
            TestPlainString("3e2",       "300");
            TestPlainString("4e3",       "4000");
            TestPlainString("5e4",       "50000");
            TestPlainString("6e5",       "600000");
            TestPlainString("7e6",       "7000000");
            TestPlainString("8e7",       "80000000");
            TestPlainString("9e8",       "900000000");
            TestPlainString("1e9",       "1000000000");
            TestPlainString(".0",        "0.0");
            TestPlainString(".1",        "0.1");
            TestPlainString(".10",       "0.10");
            TestPlainString("1e-1",      "0.1");
            TestPlainString("1e-1",      "0.1");
            TestPlainString("2e-2",      "0.02");
            TestPlainString("3e-3",      "0.003");
            TestPlainString("4e-4",      "0.0004");
            TestPlainString("5e-5",      "0.00005");
            TestPlainString("6e-6",      "0.000006");
            TestPlainString("7e-7",      "0.0000007");
            TestPlainString("8e-8",      "0.00000008");
            TestPlainString("9e-9",      "0.000000009");
            TestPlainString("9000e-12",  "0.000000009000");
            ...
            TestPlainString("-9e8",      "-900000000");
            TestPlainString("-1e9",      "-1000000000");
            TestPlainString("-0.1",      "-0.1");
            TestPlainString("-0.10",     "-0.10");
            TestPlainString("-1e-1",     "-0.1");
            TestPlainString("-1e-1",     "-0.1");
            TestPlainString("-2e-2",     "-0.02");
            TestPlainString("-3e-3",     "-0.003");
        ...
        private void TestPlainString(string bdStr, string outStr)
        {
