...
namespace Daml.Ledger.Client
{
    ...
    public interface ICommandCompletionClient
    {
        ...
        IAsyncEnumerator<CompletionStreamResponse> CompletionStream(string applicationId, IEnumerable<string> parties, string accessToken = null);
        ...
        IEnumerable<CompletionStreamResponse> CompletionStreamSync(string applicationId, IEnumerable<string> parties, string accessToken = null);
