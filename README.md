...
The quick start project shows how to read and write to the ledger for the standard skeleton model. You can find instructions on how to run it [here](Daml.Ledger.QuickStart/).
